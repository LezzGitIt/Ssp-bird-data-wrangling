...
![Phylogenetic relationships of 568 species observed in our data set. There were 25 orders, of which 19 are shown using grayscale representative species (downloaded from phylopic). The number of species in each order is listed in parentheses.](../../Figures/Phylogeny_equal_sizes.png){#fig-phylogeny}
