...
- All co-authors:
  ...
  - I think a shapefile of the rio Cesar for the sampling map if anyone could locate one.
  - Column names: Lets go with English, with a script to translate the column names to Spanish.
