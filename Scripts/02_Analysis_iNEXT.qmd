...
After running through this script once, I noticed there were several farms that had very low sample coverage (SC). I remove the 9 \[farm \* unique database \* AñoGrp\] with observed SC \< .65 in order to increase the Cmax value (see @sec-Cmax).
