...
# Next step: Join farm-specific PDFs with the regional 'Fun_factsl' PDFs using the '02_Merge_pdfs.py' script
...
# Run 'python3 Python/01_Create_pdfs.py' in terminal to execute this script
...
data_filepath = f'{output_dir}/Excels/Farm_names_IDs.xlsx'
...
for i in range(num_files):
    ...
    \\includegraphics[width=\\textwidth]{{{output_dir}/Farm_specific_inputs/Relative_Frequency_plots/{data_list[i][3]}.png}}
    
    \\newpage

    \\input{{{output_dir}/Farm_specific_inputs/Species_lists/{data_list[i][3]}.tex}}
    \\end{{document}}
    """
